...
def upgrade():
    ...
    op.drop_table('bytestream_members', if_exists=True)
    op.drop_table('bytestreams', if_exists=True)
    op.drop_table('bytespace_members', if_exists=True)
    op.drop_table('bytespaces', if_exists=True)
